...
const GlobalOverview = (props) => {
  ...
  return (
    <SafeAreaView style={GlobalStyles.container}>
      ...
      <Row width={"100%"} h={"30%"} p={25} bg="blue">
        ...
        <ZStack alignItems={"center"} justifyContent={"center"}>
          ...
          <Box
            w={size.width * 0.32}
            h={PixelRatio.get() > 2 ? size.height * 0.16 : size.height * 0.18}
            borderRadius={(size.height * 0.5) / PixelRatio.get()}
      ...
      <Row w={"100%"} justifyContent={"space-evenly"} mt={2} mb={2.5}>
